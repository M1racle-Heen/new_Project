...
tl1.from("#hTl1",.5,{x:-200,opacity: 0});
tl1.from("#rTl1",1,{y:-100,opacity: 0},"=-1");
tl4.from("#hTl2",.5,{x:200,opacity: 0});
tl4.from("#rTl2",1,{y:100,opacity: 0},"=-1");
tl5.from("#hTl3",.5,{x:-200,opacity: 0});
tl5.from("#rTl3",1,{y:-100,opacity: 0},"=-1");
tl6.from("#hTl4",.5,{x:-200,opacity: 0});
tl6.from("#rTl4",1,{y:100,opacity: 0},"=-1");
tl7.from("#hTl5",.5,{x:-200,opacity: 0});
tl7.from("#rTl5",1,{y:100,opacity: 0},"=-1");
tl8.from("#hTl6",.5,{x:200,opacity: 0});
tl8.from("#rTl6",1,{y:-200,opacity: 0},"=-1");
/*
